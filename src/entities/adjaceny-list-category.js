...
var Category = exports.Category = function () {
    ...
    (function () {
        ...
        _parent_decorators = [(0, typeorm_1.ManyToOne)(function (type) { return Category; }, function (category) { return category.children; })];
        _children_decorators = [(0, typeorm_1.OneToMany)(function (type) { return Category; }, function (category) { return category.parent; })];
        ...
        __esDecorate(null, null, _parent_decorators, { kind: "field", name: "parent", static: false, private: false, access: { has: function (obj) { return "parent" in obj; }, get: function (obj) { return obj.parent; }, set: function (obj, value) { obj.parent = value; } } }, _parent_initializers, _instanceExtraInitializers);
        __esDecorate(null, null, _children_decorators, { kind: "field", name: "children", static: false, private: false, access: { has: function (obj) { return "children" in obj; }, get: function (obj) { return obj.children; }, set: function (obj, value) { obj.children = value; } } }, _children_initializers, _instanceExtraInitializers);
